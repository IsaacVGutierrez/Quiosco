...
namespace Quiosco
{
    public partial class FormRegistroProveedores : Form
    {
        ...
        /* private void dgvProveedor_CellClick(object sender, DataGridViewCellEventArgs e, FormRegistroProveedores formRegistroProveedores)
         {

             TabControl.SelectTab(formRegistroProveedores);
             DataSet ds = new DataSet();
        ...
        public bool ValidacionCamposProveedor()
        {
            ...
            else if (txtTelefonoProveedor.Text.Length > 30 || txtTelefonoProveedor.Text.Length < 3)
            {
                MessageBox.Show("Solo se permiten telefonos entre 3 y 30 caracteres", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return false;
            }
        ...
        private void btnEliminarProveedor_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    TxtBox_a_ObjProveedor();
            //    nGrabados = objNegProveedor.abmProveedor("Baja", objEntProveedor);
            //    if (nGrabados == -1)
            //    {
            ...
            //    else
            //    {
            //        MessageBox.Show("Se logró eliminar Proveedor con éxito");
            //        LlenarDGVProveedor();
            //        LimpiarProveedor();
            //        LlenarCombos();
            //        tabControl1.SelectTab(tabProveedor);
