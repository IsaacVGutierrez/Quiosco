...
namespace Quiosco.BD
{
    public class ListaProveedor : DatosConexionBD
    {
        ...
        public int abmProveedor(string accion, Proveedor objProveedor)
        {
            ...
            if (accion == "Modificar")
                orden = $"update Proveedor set NombreProveedor = '{objProveedor.NombreProveedor}' where id = {objProveedor.IdProveedor};  update Proveedor set TelefonoProveedor = '{objProveedor.TelefonoProveedor}' where id = {objProveedor.IdProveedor}; update Proveedor set DireccionProveedor = '{objProveedor.DireccionProveedor}' where id = {objProveedor.IdProveedor}; update Proveedor set HorarioProveedor = '{objProveedor.HorarioProveedor}' where id = {objProveedor.IdProveedor};  update Proveedor set DiasProveedor = '{objProveedor.DiasProveedor}' where id = {objProveedor.IdProveedor}; ";
