...
namespace Quiosco.BD
{
    ...
    public class ListaCliente : DatosConexionBD
    {
        ...
        public int abmCliente(string accion, Cliente objCliente)
        {
            ...
            if (accion == "Modificar")
                orden = $"update Cliente set NombreCliente = '{objCliente.NombreCliente}' where id = {objCliente.IdCliente};  update Cliente set TelefonoCliente = '{objCliente.TelefonoCliente}' where id = {objCliente.IdCliente}; update Caja set AdeudaCliente = '{objCliente.AdeudaCliente}' where id = {objCliente.IdCliente};";
        ...
        public List<Cliente> ObtenerCliente()
        {
            ...
            try
            {
                ...
                while (dataReader.Read())
                {
                    ...
                    cliente.TelefonoCliente = dataReader.GetInt32(2);
                    cliente.AdeudaCliente = dataReader.GetInt32(3);
